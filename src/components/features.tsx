...
const features = [
  {
    ...
    description: "Работаем напрямую с заводами-изготовителями, обеспечивая конкурентные оптовые цены без посредников.",
    animation: "shield",
  },
  {
    title: "Комплексные решения",
    description: "Подбираем полный спектр аппаратуры для автоматизации производственных линий и энергообъектов.",
    animation: "zap",
  },
  {
    title: "Технический подбор",
    description: "Наши инженеры помогут подобрать аналоги или составить спецификацию по вашему проекту.",
    animation: "chart",
  },
  {
    title: "Наличие на складе",
    description: "Поддерживаем запас наиболее востребованных позиций для оперативной отгрузки заказчикам.",
    animation: "pulse",
  },
  {
    title: "Сертификация",
    description: "Всё оборудование соответствует государственным стандартам и имеет необходимую разрешительную документацию.",
    animation: "target",
  },
  {
    title: "Гибкая логистика",
    description: "Собственная служба доставки и отлаженная работа с ТК по всему Центрально-Черноземному региону.",
    animation: "globe",
  },
]
